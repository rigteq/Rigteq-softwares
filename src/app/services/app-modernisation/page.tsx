          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <h2 className="text-3xl md:text-5xl font-bold font-heading">
                Elevate Your Business with <span className="text-gradient">Application Modernisation</span>
              </h2>
              <p className="text-lg text-muted-foreground">
                Upgrade your legacy systems to modern cloud-native architectures securely and efficiently. Our solutions are designed to scale with your enterprise, offering robust performance, security, and unparalleled innovation.
              </p>
            ...
            >
              <div className="aspect-square md:aspect-[4/3] rounded-3xl overflow-hidden glass-card relative z-10 p-2">
                <div className="w-full h-full bg-muted rounded-2xl flex items-center justify-center relative overflow-hidden">
                    ...
                    <span className="font-heading text-2xl text-muted-foreground z-10 text-center px-4">Application Modernisation <br/> Visualisation</span>
                </div>
              </div>
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10 text-center max-w-3xl">
          ...
          <p className="text-xl text-muted-foreground mb-10">
            Let&apos;s discuss how we can implement Application Modernisation to drive growth for your business.
          </p>
